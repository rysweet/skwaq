...
class TestQueryOptimizer:
    ...
    def test_analyze_query(self):
        ...
        result2 = optimizer.analyze_query("MATCH (n:Label) WHERE n.prop = 'value' RETURN n")
        result3 = optimizer.analyze_query("MATCH (n) OPTIONAL MATCH (n)-[:REL1]->(m) OPTIONAL MATCH (n)-[:REL2]->(p) OPTIONAL MATCH (n)-[:REL3]->(q) RETURN n,m,p,q")
...
class TestDatabaseOptimization:
    ...
    def test_cached_query_decorator(self):
        ...
        # Setup mocks
        with patch('skwaq.integration.performance_optimization.get_performance_optimizer') as mock_get_optimizer:
