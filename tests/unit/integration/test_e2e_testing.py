...
class TestE2ETestScenario:
    ...
    def test_run_with_steps_and_assertions(self):
        ...
        scenario.add_assertion(name="passing_assertion", condition=passing_assertion, error_message="Passing assertion failed")
        scenario.add_assertion(name="failing_assertion", condition=failing_assertion, error_message="Failing assertion failed")
...
class TestAsyncE2ETestScenario:
    ...
    async def test_run(self):
        ...
        scenario.add_assertion(name="async_assertion", condition=assertion_mock, error_message="Async assertion failed")
...
class TestE2ETestRunner:
    ...
    def test_run_async_scenario(self):
        ...
        runner._is_async_scenario = MagicMock(return_value=False)  # Treat as synchronous for test
...
class TestPredefinedScenarios:
    ...
    def test_vulnerability_research_scenario(self):
        ...
        with patch('skwaq.integration.e2e_testing.VulnerabilityResearchWorkflow'), \
             patch('skwaq.integration.e2e_testing.PredefinedScenarios.create_vulnerability_research_scenario') as mock_method:
