...
class TestBaseAgent:
    ...
    @pytest.mark.asyncio
    async def test_start_stop_lifecycle(self, mock_config, mock_openai_client, mock_agent_registry):
...
class TestAgentRegistry:
    ...
    def setup_registry(self, monkeypatch):
        ...
        self.original_agents_by_name = skwaq.agents.registry.AgentRegistry._agents_by_name
        self.original_agents_by_type = skwaq.agents.registry.AgentRegistry._agents_by_type
        ...
        skwaq.agents.registry.AgentRegistry._agents_by_name = self.original_agents_by_name
        skwaq.agents.registry.AgentRegistry._agents_by_type = self.original_agents_by_type
