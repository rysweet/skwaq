...
@pytest.fixture
def mock_main(mock_create_parser, mock_register_all_parsers, mock_error_func, command_return_values):
    ...
    async def _mock_main(args=None):
        ...
        if not hasattr(parsed_args, 'command') or not parsed_args.command:
            mock_error_func("No command specified. Use --help to see available commands.")
            return 1
...
@pytest.mark.asyncio
async def test_main_unknown_command(patch_modules, mock_main, mock_parser, mock_error_func):
...
@pytest.mark.asyncio
async def test_main_analyze_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_repo_list_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_investigations_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_gui_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_qa_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_inquiry_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_tool_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_research_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_ingest_command(patch_modules, mock_main, mock_parser, command_return_values):
...
@pytest.mark.asyncio
async def test_main_config_command(patch_modules, mock_main, mock_parser, command_return_values):
