...
def mock_async_model_client():
    ...
    client = MagicMock()
    client.get_completion = AsyncMock(return_value="This is a code summary generated by the LLM")
...
def mock_summarizer():
    ...
    summarizer.summarize_files = AsyncMock(return_value={
        "stats": {
            "files_processed": 3,
            "errors": 0,
            "total_tokens": 1000,
...
def mock_documentation_processor():
    ...
    processor = MagicMock()
    processor.process_local_docs = AsyncMock(return_value={
        "files_processed": 2,
        "errors": 0,
    })
    processor.process_remote_docs = AsyncMock(return_value={
        "files_processed": 1,
        "errors": 0,
    })
    return processor