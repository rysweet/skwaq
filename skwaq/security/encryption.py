...
class EncryptionManager:
    ...
    def __init__(self):
        ...
        self._data_keys: Dict[DataClassification, EncryptionKey] = {
            DataClassification.PUBLIC: EncryptionKey(key=b"no-encryption-used", algorithm="none"),
    ...
    def _get_or_create_encryption_key(self, config_key: str = "encryption.default_key") -> EncryptionKey:
    ...
    def encrypt(
        self, data: Union[str, bytes, Dict[str, Any]], classification: DataClassification = DataClassification.INTERNAL
    ) -> bytes:
        """Encrypt data.
    ...
    def encrypt_dict(
        self, data: Dict[str, Any], classification: DataClassification = DataClassification.INTERNAL
    ) -> str:
