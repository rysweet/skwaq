...
class CommunicationChannel:
    ...
    def unsubscribe(self, workflow_id: str) -> None:
        ...
        if workflow_id in self._subscribers:
            ...
            logger.debug(f"Workflow {workflow_id} unsubscribed from channel {self.name}")
...
class WorkflowCommunicationManager:
    ...
    def create_channel(self, channel_name: str) -> CommunicationChannel:
        ...
        if channel_name in self._channels:
            logger.warning(f"Channel {channel_name} already exists, returning existing channel")
    ...
    def subscribe_workflow(
        self, workflow_id: str, channel_name: str
    ) -> bool:
