    ...
    async def _process_task(self, task_id: str) -> None:
        ...
        try:
            ...
            if task.task_type == "retrieve_knowledge":
                result = await knowledge_provider.retrieve_knowledge(task.task_parameters)
            elif task.task_type == "retrieve_vulnerability_patterns":
                result = await knowledge_provider.retrieve_vulnerability_patterns(task.task_parameters)
