...
def prompt_for_integer(
    ...
    return IntPrompt.ask(
        ...
        console=console,
        default=default,
        choices=[str(i) for i in range(min_value or 0, (max_value or 100) + 1)]
...
def prompt_for_api_key(
    ...
    """
    if current_value:
        masked_key = current_value[:4] + "*" * (len(current_value) - 8) + current_value[-4:]
    ...
    return Prompt.ask(
        ...
        console=console,
        password=True,
        default="" if current_value else None
    )