...
from ..ui.formatters import format_panel, format_investigation_table, format_findings_table 
...
class VulnerabilityResearchCommandHandler(CommandHandler):
    ...
    async def handle(self) -> int:
        ...
        try:
            ...
            # Clean up
            await workflow.cleanup()"""Command handlers for investigation management."""
