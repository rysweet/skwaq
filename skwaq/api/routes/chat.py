...
def create_conversation() -> Response:
    ...
    event_service.publish_event("chat", "conversation_created", {
...
def delete_conversation(conversation_id: str) -> Response:
    ...
    event_service.publish_event("chat", "conversation_deleted", {
...
def send_message(conversation_id: str) -> Response:
    ...
    message = asyncio.run(chat_service.send_message(
    ...
    event_service.publish_event("chat", "message_sent", {
        "conversationId": conversation_id,
