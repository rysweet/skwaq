...
async def test_chat_completion() -> None:
    ...
    try:
        ...
        messages = [
            ...
            {"role": "user", "content": "Say hello and identify what type of response you're returning."}
        ]
...
async def test_llm_analyzer_simulation() -> None:
    ...
    try:
        ...
        messages = [
            {"role": "system", "content": "Identify if this function is a source of data."},
            {"role": "user", "content": "Function example() { return getUserInput(); }"}
        ]
